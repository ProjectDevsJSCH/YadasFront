...
import { TableAutoFilter, TableAutoFilterCondition, TableAutoFilterTypes } from '@/components/tables/auto-filter.interface';
...
export default class TestRoute extends Vue {
  // ? Should it be worth to have an item's builder function
